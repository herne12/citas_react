...
const Formulario = ({pacientes ,setPacientes, paciente, setPaciente}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (paciente.id) {
      ...
      const pacienteActualizado = pacientes.map(pacienteEstado=>
        pacienteEstado.id === paciente.id ? objPacientes : pacienteEstado
      )
      ...
      //agregar objeto paciente al arregl de pacientes copiando el arreglo pacientes.
